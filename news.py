...
# Store results
q1_results = dict()
q1_results['title'] = "1. The most popular three articles of all time?"
q1_results['ending'] = " views"

q2_results = dict()
q2_results['title'] = "2. Who are the most popular article authors of all time?"
...
def print_query_results(query_results):
    ...
    for result in query_results['results']:
        print ('\t' + str(result[0]) + ': ' + str(result[1]) + query_results['ending'])
